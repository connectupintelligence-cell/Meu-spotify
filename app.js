...
let backendUrl = "https://meu-spotify-1.onrender.com";
...
function loadSettings() {
  try {
    ...
    backendUrl = localStorage.getItem("scribe_backend_url") || "https://meu-spotify-1.onrender.com";
...
function saveSettings() {
  try {
    ...
    const bUrl = document.getElementById("api-backend-url").value.trim() || "https://meu-spotify-1.onrender.com";
